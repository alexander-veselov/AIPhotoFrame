...
if __name__ == '__main__':
    ...
    parser.add_argument('--prompt', type=str, required=False, default="1girl", help="Positive prompt.")
    parser.add_argument('--negative_prompt', type=str, required=False, default="nsfw", help="Negative prompt.")
